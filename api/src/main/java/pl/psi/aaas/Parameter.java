 ...
 * Parameter is used by EngineValuesSender and EngineValuesReceiver. Parameter has four implementations: *
 * {@link Primitive} * {@link Vector} * Matrix (not yet implemented) * {@link DataFrame} Currently supported
 * types are: * String * Long * Double * Boolean * ZonedDateTime
 */
public abstract class Parameter< T >
{
    public static final List< Class< ? > > supportedClasses =
        Arrays.asList( java.lang.String.class, String.class, java.lang.Long.class, Long.class,
            java.lang.Double.class, Double.class, java.lang.Boolean.class, Boolean.class, ZonedDateTime.class,
            Vector.class );
    ...
    public static < T > Vector< T > ofArray( T[] value )
    {
        ...
        return ofArray( value, (Class< T >)value.getClass()
            .getComponentType() );
    }
